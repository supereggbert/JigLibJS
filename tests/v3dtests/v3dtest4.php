...
<script type="text/javascript" src="vector3dutil_new3.js"></script>
...
class</a>
<div style="display: none;" id="vo"><pre class="sh_javascript"><code><?php include('vector3dutil_new3.js'); ?></code></pre>
</div>
