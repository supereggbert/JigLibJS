...
<script type="text/javascript" src="vector3d2.js"></script>
...
<h3>vanilla arrays &amp; a utility class vs a complex value object
using Float32Array</h3>
...
<br />
<a href="javascript:toggleDiv('vo');">show/hide complex Float32Array
value object class</a>
<div style="display: none;" id="vo"><pre class="sh_javascript"><code><?php include('vector3d2.js'); ?></code></pre>
</div>
